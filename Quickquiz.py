...
kategoriler = [
    ...
    Kategori("Kimya", [
        ...
        {"soru": "Asidik bir çözelti hangi renk gösterilir?",
          "cevap": "kırmızı",
        ...
        {"soru": "Asidik çözelti turnusol kağıdında ne renk olur?",
          "cevap": "Kırmızı",
            "aciklama": "Asidik çözeltiler turnosol kağıdında kırmızı gözükür."},
        {"soru": "Gaz halinden katı hale geçmeye ne ad verilir?",
          "cevap": "Kırağılaşma",
            "aciklama": "Gaz halinden katı hale geçmeye Kırağılaşma denir."},
        {"soru": "Bazik çözeltiler turnusol kağıdına batırıldıklarında hangi rengi alır?",
          "cevap": "mavi",
            "aciklama": "Bazik çözeltiler turnusol kağıdına batırıldığında mavi bir hal alır."},
        ...
        {"soru": "Tuzun kimyasal formülü nedir?",
          "cevap": "NaCl",
            "aciklama": "Sodyum Klorür yani halk arasında tuz olarak bilinir."},
        ...
        {"soru": "Bir çözeltinin asidik mi bazik mi olduğunu gösteren madde nedir?",
          "cevap": "turnusol kağıdı",
            "aciklama": "Turnusol kağıdı, çözeltinin asidik veya bazik olduğunu gösteren bir araçtır."},
